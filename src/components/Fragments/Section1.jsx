    ...
    return (
        <section id="section1" className="lg:pt-30 md:pt-20 pt-16 dark:bg-dark ">
            <div className="container">
                <div className="px-4">
                <h1 className="md:text-3xl text-2xl lg:text-4xl font-bold bg-gradient-to-r from-purple-600 to-purple-900 hover:opacity-80 inline-block text-transparent bg-clip-text">Perbaikan Smartphone</h1>
                    <div className="bg-purple-100 dark:bg-slate-800 lg:h-[250px] mt-10 p-8 rounded-3xl flex flex-col lg:flex-row items-center">
